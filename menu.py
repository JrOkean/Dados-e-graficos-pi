...
def mostrarquestaoL10():
  escolha_genero = input("Escolha o gênero que deve ser apresentado no gráfico, M para masculino e F para feminino. \n").upper()
...
def mostrarquestaoB5():
  ...
  escolha_Tipo = input("Qual das temporadas você escolhe? Digite summer para verão, ou winter para inverno. \n").upper()
  while True:
...
def mostrarquestaoExtra():
  ...
  RetornaAoMenu(ano2)
  FecharPrograma(ano2)
  tipoOlimpiada = input("Qual das temporadas você escolhe? Digite summer para verão, ou winter para inverno. \n").upper()
  ...
  try:
    ...
    print('--Houve um problema com os valores digitados. Por favor, leia as questões com atenção e tente novamente--')
    mostrarquestaoExtra()
